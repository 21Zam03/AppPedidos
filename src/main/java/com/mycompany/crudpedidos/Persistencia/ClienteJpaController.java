...
import com.mycompany.crudpedidos.Persistencia.exceptions.PreexistingEntityException;
    ...
    public void create(Cliente cliente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Pedido pedidosPedidoToAttach : cliente.getPedidos()) {
                pedidosPedidoToAttach = em.getReference(pedidosPedidoToAttach.getClass(), pedidosPedidoToAttach.getCodigo_Pedido());
    ...
    public void edit(Cliente cliente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Pedido pedidosNewPedidoToAttach : pedidosNew) {
                pedidosNewPedidoToAttach = em.getReference(pedidosNewPedidoToAttach.getClass(), pedidosNewPedidoToAttach.getCodigo_Pedido());
